export const FORUM_TIERS = [
  ...
  },
  {
    ...
    optional: [
      ...
      { type: 'shipment_equipment_collected', target: 30, label: 'Find 30 items in shipments' },
  ...
  },
  {
    ...
    optional: [
      ...
      { type: 'shipment_equipment_collected', target: 55, label: 'Find 55 items in shipments' },
  ...
  },
  {
    tier: 5,
    label: 'Tier 5',
    description: `Your trading empire continues to expand. Your armory grows.`, // TODO: real flavor text
    required: [
    ...
    optional: [
      ...
      { type: 'shipment_equipment_collected', target: 100, label: 'Find 100 items in shipments' },
  ...
  },
  {
    tier: 6,
    label: 'Tier 6',
    description: `As you continue to grow, you start finding more uncommon equipment.`, // TODO: real flavor text
    required: [
    ...
    optional: [
      ...
      { type: 'shipment_equipment_collected', target: 150, label: 'Find 150 items in shipments' },
      { type: 'total_forum_runs', target: 85, label: 'Complete 85 forum runs' },
      { type: 'depthsle_best_score', target: 150, label: 'Reach a Depthsle treasure score of 400 in one run' },
    ],
    minOptional: 3,
  },
  {
    ...
    optional: [
      ...
      { type: 'shipment_equipment_collected', target: 220, label: 'Find 220 items in shipments' },
...
export const TOWN_UNLOCKS = [
  ...
  },
  {
    ...
    optional: [
      { type: 'shipment_equipment_collected', target: 8, label: 'Find 8 items in shipments' },
      { type: 'caches_opened', target: 50, label: 'Open 50 caches' },
    ],
    minOptional: 1,
  },
  {
    ...
    optional: [
      { type: 'items_traded_total', target: 25, label: 'Trade away 25 items total' },
      { type: 'town_level', townId: 'alnera', target: 6, label: 'Reach Alnera level 6' },
      { type: 'shipment_equipment_collected', target: 15, label: 'Find 15 items in shipments' },
    ],
    minOptional: 1,
  },
  {
    ...
    optional: [
      { type: 'items_traded_total', target: 65, label: 'Trade away 65 items total' },
      { type: 'town_level', townId: 'frostgate', target: 6, label: 'Reach Frostgate level 6' },
      { type: 'shipment_equipment_collected', target: 50, label: 'Find 50 items in shipments' },
